...
import { Heart, Calendar, Users, ChevronRight, Star } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen bg-white font-sans overflow-x-hidden">
        {/* Hero Section — Solid Colors Only */}
        <section className="relative bg-gradient-to-r from-[#FACC15] to-[#FDE68A] py-28 md:py-36 text-black">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-5">
                <Link to="/register">
                  <Button
                    className="bg-white text-black hover:bg-gray-50 border border-gray-200 text-lg px-8 py-4 rounded-xl font-bold shadow-md hover:shadow-lg transition-all"
                  >
                    👥 Daftar Anggota
                  </Button>
                </Link>
        ...
        {/* Fitur Utama — Teks Solid, Tanpa Gradient */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {[
                ...
                <Card
                  key={i}
                  className="bg-[#FEF9C3] hover:bg-[#FFFBE6] border border-[#FDE68A] rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all"
                >
        ...
        {/* Sekolah & Kegiatan — Teks Hitam/Jelas */}
        <section className="py-20 bg-[#FEF9C3]">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              {/* Sekolah */}
              <div>
                <h2 className="text-3xl font-bold text-[#1F2937] mb-6">Sekolah-Sekolah Anggota</h2>
                ...
                <div className="flex flex-wrap gap-3">
                  {schools.map((school, i) => (
                    <span
                      key={i}
                      className="bg-white px-4 py-2 rounded-full text-[#1F2937] text-sm font-medium border border-[#FDE68A] shadow-sm"
                    >
                      {school}
                    </span>
                  ))}
              ...
              {/* Kegiatan */}
              <div>
                <h2 className="text-3xl font-bold text-[#1F2937] mb-6">Kegiatan Terbaru</h2>
                <div className="space-y-4">
                  {kegiatans.length > 0 ? (
                    kegiatans.map((kegiatan) => (
                      <div
                        key={kegiatan.id}
                        className="bg-white p-5 rounded-xl border-l-4 border-[#FACC15] shadow-sm"
                      >
                        <div className="font-bold text-[#1F2937]">{kegiatan.judul}</div>
        ...
        {/* Renungan Harian — Teks Hitam, Background Putih/Kuning Lembut */}
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-[#1F2937] mb-8">Renungan Harian</h2>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-lg text-[#1F2937]">{renungan?.judul || 'Judul tidak ditemukan'}</h3>
                      <p className="text-[#1F2937] mt-2 italic">"{renungan?.isi || 'Tidak ada teks renungan'}"</p>
                      <div className="mt-3">
                        <span className="inline-block bg-[#FEF9C3] text-[#1F2937] text-xs px-2 py-1 rounded-full">
        ...
        {/* CTA Final — Teks Hitam, Kontras Tinggi */}
        <section className="py-20 bg-[#FACC15] text-black text-center">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link to="/donasi">
                  <Button
                    className="bg-white text-black hover:bg-gray-50 border border-gray-200 font-bold px-8 py-4 rounded-xl text-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2"
                  >
