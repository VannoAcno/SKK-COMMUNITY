...
export default function DonasiPerBulan() {
                                ...
                                <Card className="border-0 shadow-sm">
                                    <CardContent className="p-6">
                                        <div className="text-center py-12">
                                            <Heart size={48} className="mx-auto mb-4 text-[#10B981]" />
    ...
    // ✅ Perbaikan: CustomTooltip yang lebih aman
    const CustomTooltip = ({ active, payload, label }) => {
        if (active && payload && payload.length > 0) {
            return (
                <div className="bg-white p-4 border border-[#10B981] rounded-lg shadow-lg">
                    <p className="font-bold text-[#374151] mb-2">{label}</p>
                    <p className="text-sm text-[#6B7280]">
                        Total Donasi: <span className="font-semibold text-[#10B981]">{formatFullRupiah(payload[0].value)}</span>
                    </p>
                    <p className="text-sm text-[#6B7280]">
                        Jumlah Donasi: <span className="font-semibold">{payload[0].payload.jumlahDonasi || 0}</span>
                    </p>
                    <p className="text-sm text-[#6B7280]">
                        Rata-rata: <span className="font-semibold text-[#10B981]">{formatFullRupiah(payload[0].payload.rataRata || 0)}</span>
                    </p>
                </div>
            );
        }
                                    ...
                                    <CardContent className="p-6">
                                        <div className="mb-6 flex items-center justify-between">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    onClick={exportToCSV}
                                                    className="flex items-center gap-2 px-4 py-2 bg-[#10B981] text-white rounded-lg hover:bg-[#0DA271] transition-colors"
                                                >
                                                    <Download size={18} />
                                                    Export CSV
                                                </button>
                                                <div className="relative">
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 px-4 py-2 bg-white border border-[#10B981] text-[#10B981] rounded-lg hover:bg-[#10B981]/10 transition-colors"
                                                    >
                                                        <Filter size={18} />
                                                        {tahun}
                                                        ...
                                                        <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                                                            {tahunList.map((year) => (
                                                                <button
                                                                    ...
                                                                    className={`w-full px-4 py-2 text-left hover:bg-[#10B981]/10 transition-colors ${tahun === year ? "bg-[#10B981]/20 font-semibold" : ""}`}
                                                                >
                                                                    {year}
                                                                </button>
                                                            ))}
                                            ...
                                            <CardContent className="p-6">
                                                ...
                                                <div className="overflow-x-auto">
                                                    <table className="w-full">
                                                        ...
                                                        <tfoot>
                                                            <tr className="bg-[#10B981]/10 font-bold">
